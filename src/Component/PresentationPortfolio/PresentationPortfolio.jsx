...
const investorPitchDecksData = [
  {
    id: 1,
    webImage: "/images/investor/Slide17.jpg",
    fullImage: "/images/investor/Slide17.jpg",
    likeCount: 342,
    views: 687,
    type: "InvestorPitch",
    selected: false,
  ...
  {
    id: 2,
    webImage: "/images/investor/Slide18.jpg",
    fullImage: "/images/investor/Slide18.jpg",
    likeCount: 298,
    views: 534,
    type: "InvestorPitch",
    selected: false,
...
const brandedMasterTemplatesData = [
  {
    id: 1,
    webImage: "/images/brand-master-template/Slide21.jpg",
    fullImage: "/images/brand-master-template/Slide21.jpg",
    likeCount: 278,
    views: 456,
    type: "InvestorPitch",
    selected: false,
  ...
  {
    id: 2,
    webImage: "/images/brand-master-template/Slide22.jpg",
    fullImage: "/images/brand-master-template/Slide22.jpg",
    likeCount: 423,
    views: 678,
    type: "InvestorPitch",
    selected: false,
...
const businessPresentationsData = [
  ...
  {
    id: 1,
    webImage: "/images/business-presentation/Slide19.jpg",
    fullImage: "/images/business-presentation/Slide19.jpg",
    likeCount: 367,
    views: 598,
    type: "InvestorPitch",
    selected: false,
  ...
  {
    id: 2,
    webImage: "/images/business-presentation/Slide20.jpg",
    fullImage: "/images/business-presentation/Slide20.jpg",
    likeCount: 445,
    views: 712,
    type: "InvestorPitch",
    selected: false,
...
const PresentationPortfolio = ({ type }) => {
  ...
  const currentHeading =
    headings[type] || headings[PresentationType.InvestorPitchDecks];
  const currentPortfolio =
    portfolioData[type] || portfolioData[PresentationType.InvestorPitchDecks];
