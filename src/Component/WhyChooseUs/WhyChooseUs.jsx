...
const WhyChooseUs = ({ type }) => {
  const services = [
    ...
    },
    {
      ...
      title: "Fast Delivery",
      description: "Need it now? Get your deck ready in as little as 4 hours.",
    },
    {
  ...
  const Mobservices = [
    {
      ...
      description: " Cross-platform apps built from ready designs.",
    },
    {
    ...
    },
    {
      ...
      description: "From development to App Store & Play Store launch.",
    },
    {
      icon: "/images/service-icon/c-s-c.svg",
      title: "Clean, Scalable Code",
      description: "Built for performance and long-term reliability.",
    },
  ];

  const servicesType =
    type == PresentationType.MobileApp ? Mobservices : services;
      ...
      <div className="container  why-choose-setion">
        <div className="choose-us-wrapper">
          ...
          {type != PresentationType.MobileApp ? (
            <p className="p1">
              <span className="red-color bold"> Devpixel,</span> Solution, we
              don’t just build apps  we create products that people actually
              use and scale. With 300+ apps delivered, we combine AI, strong
              backend systems, and clean architecture. You get a reliable tech
              partner focused on results, not just development.
            </p>
          ) : (
            <p className="p1 " style={{ maxWidth: "870px", margin: "auto" }}>
              At <span className="red-color bold"> DevPixel Solution,</span> we
              deliver complete <b>full-stack app</b> solutions using{" "}
              <b>React Native</b> and Node.js, ensuring fast, scalable, and
              high-performance mobile applications from front to back
            </p>
          )}
        </div>
